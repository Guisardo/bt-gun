...
- [x] 08-03-PLAN.md — Pure Android profile mapper and latency-capped adaptive smoother.

**Wave 3** *(blocked on Wave 2 completion)*

- [x] 08-04-PLAN.md — Runtime active-profile wiring into HID, LAN mapped stream, and control metadata.

**Wave 4** *(blocked on Wave 3 completion)*

- [x] 08-05-PLAN.md — Android profile management UI and dashboard profile rows.
- [x] 08-06-PLAN.md — Desktop read-only active Android profile metadata and mapped-stream diagnostics.
...
- [x] 09-02-PLAN.md — Separate Swing visualizer shell, manual reopen action, and authenticated auto-open path.

**Wave 2** *(blocked on Wave 1 for 09-03; blocked on Wave 0 for 09-04)*

- [x] 09-03-PLAN.md — Live gamepad panels, metrics display, raw-debug drawer, event strip, and LAN phone haptic action.
- [x] 09-04-PLAN.md — Android sanitized visualizer status diagnostics for recenter, aim-zero, raw-debug, and clock context.
...
- [x] 10-01-PLAN.md - Replay fixtures and full-chain visualizer replay test.
- [x] 10-03-PLAN.md - Android diagnostic reporter and dashboard rows.
...
- [x] 10-04-PLAN.md - Desktop visualizer diagnostic rendering.

**Wave 4** *(blocked on Wave 3 completion)*

- [x] 10-05-PLAN.md - Sanitized diagnostic export and redaction gate.
...
- [x] 10-07-PLAN.md - Version 1 docs index and closeout validation audit.
